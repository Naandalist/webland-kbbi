...
export const appInfo = {
	...
	description:
		"Aplikasi mobile yang memuat seluruh kosakata bahasa Indonesia sesuai standar resmi, memungkinkan pengguna untuk dengan mudah mencari dan memahami arti kata.",
	logo: {
